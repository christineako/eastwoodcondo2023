...
<head>
	...
	<meta name="description" content="Find properties for rent in the Philippines. Condominiums, house and lots, vacant lots, offices, warehouses, farms.">
...
<!-- FIRST ROW -->
	<div class="row">
		<?php echo cfg::get('othersaleHTML');?>
	</div>		


<!-- SECOND ROW -->
	<div class="row panel panel-primary">
		<div class="panel-heading">Properties For Sale in the Philippines</div>
		<div class="panel-body">
					<?php echo cindy('othersale'); ?>			
