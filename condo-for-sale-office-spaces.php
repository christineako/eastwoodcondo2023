...
<html lang="en">
<head>
	<title>Office Space Building | Eastwood City | Offics For Sale</title>
...
<!-- FIRST ROW -->
	<div class="row">
		<?php echo cfg::get('officesaleHTML');?>
	</div>		
	

<!-- SECOND ROW -->
	<div class="row panel panel-primary">
		<div class="panel-heading">Office Spaces For Sale</div>
		<div class="panel-body">	
					<?php echo cindy('officesale'); ?>
