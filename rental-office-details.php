...
//CREATING PHOTO DISPLAY
	...
	$num = $files[$i];
		...
		{	$picS = "<div class='item'>";	}
			...
			$picS = $picS."
					<img src='".$num."' width='800' height='386' class='img-thumbnail' alt='".ucwords(strtolower($bldgname))." ".ucwords(strtolower($bldglocation))."'>
					</div>";
			$pic = $pic . $picS;
	 	} 
...
//CREATING PROPERTY DETAILS
	...
	if ($bldgamenities="") {
		...
		$bamenities = "
				<tr>
					<td>Amenities:</td>
					<td>".ucwords(strtolower($bldgamenities))."</td>
				</tr>
		";
	}
...
<head>
	...
	<meta name="keyword" content="<?php echo ucwords($metakeywords); ?>"></meta>
